<%@taglib prefix="security" uri="http://www.springframework.org/security/tags"%>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top col-sm-12" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${contextRoot}/home"><img class="logo-dark" src="${images}/logo-dark.svg" alt=""></a>
            </div>
