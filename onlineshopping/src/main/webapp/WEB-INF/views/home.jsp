...
<header class="section-top-padding background-image text-center"
	...
	<!-- Image -->
	<img class="margin-top-20 center" src="${images}/novage2.png" alt="">

	<!-- dark full width arrow object -->
	<img class="arrow-object" src="${images}/arrow-object-dark.svg" alt="">
</header>
			...
			<div class="margin2x">
				<div class="m-12 l-3 margin-bottom-30"
					...
					<div class="single-package-item">
						...
						<div class="l-12">
							<h3
								style="font-size: 19px; font-color: black; padding-top: 10px; margin-bottom: 0px; height:70px; font-family:Calibri Light;">{{product.name}}</h3>
						</div>

						<div class="l-6">
							<h3
								style="font-size: 16px; font-color: black; padding-top: 10px;margin-bottom: 10px; font-family:Bahnschrift SemiBold;">
								LKR {{product.unitPrice}}.00
							</h3>
						</div>
						
						<div class="l-6">
							<h3
								style="font-size: 14px; font-color: black; padding-top: 10px;margin-bottom: 10px; float:right;">
								{{product.brand}}
							</h3>
						</div>
						...
						<div>
							...
							<div >
								<div class="about-btn">
									...
									<a ng-href="${contextRoot}/show/{{product.id}}/product"
										class="about-view packages-btn text-white"
										style="width: 100%; height: 40px;">View</a>
								</div>
							</div>
						</div>
